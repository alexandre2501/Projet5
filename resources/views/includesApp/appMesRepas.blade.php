        ...
        <div id="meal-block" class="col s12">
            <div id="meals-content" class="col s9">
                ...
                <div class="col s3 meal-content" v-for="(value, index) in mealsData[dateIndex].meals">
                    ...
                    <div class="col s6 pad-zero"><div class="col s12 center-align #d1c4e9 deep-purple lighten-4">Calorie</div><div class="col s8 valign-wrapper"><input type="number" v-model="value.cal" @keyup="checkNumeric(index, 'cal')"><span>cal</span></div></div>
                    <div class="col s6 pad-zero"><div class="col s12 center-align #dce775 lime lighten-2">Quantité</div><div class="col s8 valign-wrapper"><input type="number" v-model="value.quant" @keyup="checkNumeric(index, 'quant')"><span>g</span></div></div>
                    <div class="col s4 pad-zero"><div class="col s12 center-align #aed581 light-green lighten-2">Protéines</div><div class="col s12 valign-wrapper"><input type="number" v-model="value.pro" @keyup="checkNumeric(index, 'pro')"><span>g</span></div></div>
