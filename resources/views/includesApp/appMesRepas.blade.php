    ...
    <div class="row repas-block #fafafa grey lighten-5 z-depth-2">
        ...
        <div id="meal-block" class="col s12">
            <div id="meals-content" class="col s9">
                ...
                <div class="col s3 meal-content" v-for="(value, index) in mealsData[dateIndex].meals">
                    ...
                    <div class="col s4 pad-zero"><div class="col s12 center-align #aed581 light-green lighten-2">Protéines</div><div class="col s12 valign-wrapper"><input class="center-align" type="number" v-model="value.pro" @keyup="checkNumeric(index, 'pro')"><span>g</span></div></div>
                    <div class="col s4 pad-zero"><div class="col s12 center-align #a1887f brown lighten-2">Lipides</div><div class="col s12 valign-wrapper"><input class="center-align" type="number" v-model="value.lip" @keyup="checkNumeric(index, 'lip')"><span>g</span></div></div>
                    <div class="col s4 pad-zero"><div class="col s12 center-align #f06292 pink lighten-2">Glucides</div><div class="col s12 valign-wrapper"><input class="center-align" type="number" v-model="value.glu" @keyup="checkNumeric(index), 'glu'"><span>g</span></div></div>
                </div>
            </div>
