const MyFood = Vue.component('MyFood',{
    template: '    <div>\n' +
    '        <div class="">\n' +
    ...
    '                    <div class="col s12"><button class="col s12 m12 l6 waves-effect waves-light btn-small" v-on:click="$emit(\'deleteFood\',index)">Supprimer</button><button class="col s12 m12 l6 waves-effect waves-light btn-small" v-on:click="$emit(\'fillUpdateFood\',index)">Modifier</button></div>\n' +
    '                </div>\n' +
    '            </div>\n' +
    '        </div>\n' +
    '    </div>\n',
